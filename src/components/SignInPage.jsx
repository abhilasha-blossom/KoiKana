...
const SignInPage = () => {
    ...
    return (
        <div className="h-screen w-full bg-[#FAFAF9] relative overflow-hidden flex flex-col items-center justify-center font-sans">
            ...
            <div className="relative z-10 w-full max-w-6xl h-full flex flex-col items-center justify-center">
                ...
                <div className="relative w-full flex justify-center items-center">
                    <svg viewBox="0 0 800 500" className="w-full h-auto drop-shadow-2xl">
                        ...
                        {/* --- PERSPECTIVE PATH --- */}
                        {/* Leading towards the sun/center */}
                        ...
                        {/* --- TORII GATE (Red, Vibrant but Pastel-ish) --- */}
                        <g transform="translate(200, 50)">
                            ...
                            {/* Lintels */}
                            <rect x="50" y="100" width="300" height="20" rx="2" fill="url(#gateRed)" /> {/* Lower */}
                            <path d="M20,60 Q200,30 380,60 L380,85 Q200,55 20,85 Z" fill="#881337" /> {/* Upper Roof (Dark) */}
                            <path d="M25,65 Q200,35 375,65 L375,75 Q200,45 25,75 Z" fill="#F43F5E" /> {/* Upper Roof (Red) */}

                            {/* Shimenawa/Rope Details */}
                        ...
                        <g transform="translate(50, 280)">
                            ...
                            <rect x="35" y="45" width="30" height="20" fill="#FEF9C3" filter="url(#softGlow)" /> {/* Light */}
                            {/* Roof */}
                    ...
                    {/* --- INPUT CONTAINER --- */}
                    {/* Positioned at bottom 0 of the SVG container, pushed down to clear the gate */}
                    <div className="absolute bottom-0 translate-y-[20%] w-full flex justify-center z-50">
            ...
            {/* Foreground Clouds (Bottom corners) */}
